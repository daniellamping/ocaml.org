...
<div class="sourceCode"><pre class="sourceCode ocaml"><code class="sourceCode ocaml"><span><a href="https://lambdafoo.com/rss.xml#cb1-1" aria-hidden="true" tabindex="-1"></a><span class="co">(* Build with:</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-2" aria-hidden="true" tabindex="-1"></a><span class="co">  ocamlfind ocamlopt -package unix -package threads -thread -linkpkg -o liquidsoap_test.exe liquidsoap_test.ml *)</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-3" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> frame_size = <span class="fl">0.04</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-4" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> pcm_len = <span class="dt">int_of_float</span> (<span class="dv">44100</span>. *. frame_size)</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-5" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> channels = <span class="dv">2</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-6" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-7" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> mk_pcm () = <span class="dt">Array</span>.init channels (<span class="kw">fun</span> _ -&gt; <span class="dt">Array</span>.make pcm_len <span class="dv">0</span>.)</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-8" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-9" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> <span class="kw">rec</span> fn a =</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-10" aria-hidden="true" tabindex="-1"></a>  <span class="kw">if</span> <span class="dt">Array</span>.length a &lt;&gt; <span class="dv">0</span> <span class="kw">then</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-11" aria-hidden="true" tabindex="-1"></a>    <span class="dt">Gc</span>.full_major ();</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-12" aria-hidden="true" tabindex="-1"></a>  <span class="kw">let</span> pcm = mk_pcm () <span class="kw">in</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-13" aria-hidden="true" tabindex="-1"></a>  <span class="dt">ignore</span>(pcm);</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-14" aria-hidden="true" tabindex="-1"></a>  Unix.sleepf <span class="fl">0.04</span>;</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-15" aria-hidden="true" tabindex="-1"></a>  fn [||]</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-16" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-17" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> () =</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-18" aria-hidden="true" tabindex="-1"></a>  <span class="kw">let</span> deadweigth = <span class="dt">Array</span>.make (<span class="dv">40</span> * <span class="dv">1024</span> * <span class="dv">1024</span>) <span class="dv">1</span> <span class="kw">in</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-19" aria-hidden="true" tabindex="-1"></a>  Unix.sleepf <span class="fl">0.04</span>;</span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-20" aria-hidden="true" tabindex="-1"></a>  <span class="kw">let</span> th = Thread.create fn deadweigth <span class="kw">in</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb1-21" aria-hidden="true" tabindex="-1"></a>  Thread.join th</span></code></pre></div>
