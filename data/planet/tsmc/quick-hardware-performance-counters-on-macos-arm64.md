...
<h2>Why Not Just Use Instruments?</h2>
...
<h2>Using Apple’s Private Frameworks</h2>
...
<h2>The Multi-Threading Problem</h2>
...
<h2>Sampling Period Trade-offs</h2>
...
<div class="sourceCode"><pre class="sourceCode bash"><code class="sourceCode bash"><span><a href="https://lambdafoo.com/rss.xml#cb3-1" aria-hidden="true" tabindex="-1"></a><span class="co"># Default 1ms - good balance for most programs</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-2" aria-hidden="true" tabindex="-1"></a><span class="fu">sudo</span> ./mperf-stat <span class="at">-e</span> cycles <span class="at">-e</span> instructions <span class="at">--</span> ./benchmark</span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-3" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-4" aria-hidden="true" tabindex="-1"></a><span class="co"># 0.5ms - catches short-lived threads, higher overhead</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-5" aria-hidden="true" tabindex="-1"></a><span class="fu">sudo</span> ./mperf-stat <span class="at">-p</span> 0.5 <span class="at">-e</span> cycles <span class="at">-e</span> instructions <span class="at">--</span> ./short_benchmark</span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-6" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-7" aria-hidden="true" tabindex="-1"></a><span class="co"># 5ms - less overhead for long-running workloads</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb3-8" aria-hidden="true" tabindex="-1"></a><span class="fu">sudo</span> ./mperf-stat <span class="at">-p</span> 5 <span class="at">-e</span> cycles <span class="at">-e</span> instructions <span class="at">--</span> ./long_benchmark</span></code></pre></div>
<h2>OCaml Bindings</h2>
...
<div class="sourceCode"><pre class="sourceCode ocaml"><code class="sourceCode ocaml"><span><a href="https://lambdafoo.com/rss.xml#cb4-1" aria-hidden="true" tabindex="-1"></a><span class="kw">open</span> Apple_perf_stat</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-2" aria-hidden="true" tabindex="-1"></a></span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-3" aria-hidden="true" tabindex="-1"></a><span class="kw">let</span> () =</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-4" aria-hidden="true" tabindex="-1"></a>  <span class="kw">match</span> run</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-5" aria-hidden="true" tabindex="-1"></a>    ~events:[<span class="st">"cycles"</span>; <span class="st">"instructions"</span>; <span class="st">"l1d-tlb-misses"</span>; <span class="st">"branch-misses"</span>]</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-6" aria-hidden="true" tabindex="-1"></a>    [<span class="st">"./my_benchmark"</span>; <span class="st">"--size"</span>; <span class="st">"10000"</span>]</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-7" aria-hidden="true" tabindex="-1"></a>  <span class="kw">with</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-8" aria-hidden="true" tabindex="-1"></a>  | <span class="dt">Ok</span> <span class="dt">result</span> -&gt;</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-9" aria-hidden="true" tabindex="-1"></a>    <span class="dt">Printf</span>.printf <span class="st">"IPC: %.2f</span><span class="ch">\n</span><span class="st">"</span> (get_ipc <span class="dt">result</span>);</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-10" aria-hidden="true" tabindex="-1"></a>    <span class="dt">Printf</span>.printf <span class="st">"Wall time: %.3f s</span><span class="ch">\n</span><span class="st">"</span> (wall_time_seconds <span class="dt">result</span>);</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-11" aria-hidden="true" tabindex="-1"></a>    (<span class="kw">match</span> get_counter <span class="st">"l1d-tlb-misses"</span> <span class="dt">result</span> <span class="kw">with</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-12" aria-hidden="true" tabindex="-1"></a>     | <span class="dt">Some</span> misses -&gt; <span class="dt">Printf</span>.printf <span class="st">"TLB misses: %Ld</span><span class="ch">\n</span><span class="st">"</span> misses</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-13" aria-hidden="true" tabindex="-1"></a>     | <span class="dt">None</span> -&gt; ())</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-14" aria-hidden="true" tabindex="-1"></a>  | <span class="dt">Error</span> e -&gt;</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-15" aria-hidden="true" tabindex="-1"></a>    <span class="dt">Printf</span>.eprintf <span class="st">"Error: %s</span><span class="ch">\n</span><span class="st">"</span> (string_of_error e);</span>
<span><a href="https://lambdafoo.com/rss.xml#cb4-16" aria-hidden="true" tabindex="-1"></a>    <span class="dt">exit</span> <span class="dv">1</span></span></code></pre></div>
...
<div class="sourceCode"><pre class="sourceCode bash"><code class="sourceCode bash"><span><a href="https://lambdafoo.com/rss.xml#cb6-1" aria-hidden="true" tabindex="-1"></a><span class="ex">$</span> dmesg <span class="kw">|</span> <span class="fu">grep</span> <span class="at">-E</span> <span class="st">"generic registers|fixed-purpose events"</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb6-2" aria-hidden="true" tabindex="-1"></a><span class="ex">...</span> generic registers:      4</span>
<span><a href="https://lambdafoo.com/rss.xml#cb6-3" aria-hidden="true" tabindex="-1"></a><span class="ex">...</span> fixed-purpose events:   3</span></code></pre></div>
...
<div class="sourceCode"><pre class="sourceCode bash"><code class="sourceCode bash"><span><a href="https://lambdafoo.com/rss.xml#cb7-1" aria-hidden="true" tabindex="-1"></a><span class="fu">git</span> clone https://github.com/tmcgilchrist/mperf</span>
<span><a href="https://lambdafoo.com/rss.xml#cb7-2" aria-hidden="true" tabindex="-1"></a><span class="bu">cd</span> mperf</span>
<span><a href="https://lambdafoo.com/rss.xml#cb7-3" aria-hidden="true" tabindex="-1"></a><span class="fu">make</span></span>
<span><a href="https://lambdafoo.com/rss.xml#cb7-4" aria-hidden="true" tabindex="-1"></a><span class="fu">sudo</span> ./mperf-stat <span class="at">--</span> echo hello</span></code></pre></div>
